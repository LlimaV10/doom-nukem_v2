...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   draw_inclined_floor_ceil_betw_kernel.c             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dbolilyi <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/05 14:37:53 by dbolilyi          #+#    #+#             */
/*   Updated: 2019/03/05 14:37:58 by dbolilyi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_save_wall *right, t_draw_wall_floor_ceil_tex_kernel *d)
{
	...
	CL_TRUE, 0, 19 * sizeof(float), d->cfloat, 0, NULL, NULL);
	...
	t_save_wall *right, int len)
{
	...
	d.local_item_size = 1;
	iw->k.ret = clEnqueueNDRangeKernel(iw->k.command_queue, iw->k.kernel2, 1,
