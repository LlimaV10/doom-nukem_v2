...
typedef struct    s_sound
{
	...
	void		*music_pack[MUSIC_COUNT];
	size_t		music_pack_size[MUSIC_COUNT];
	SDL_RWops	*music_rw[MUSIC_COUNT];
	//x - xxxxx - chanel
	//0 - steps - 0
	//1 - jump - 0
	//2 - door opening - 1
	...
	//20 - enemy0_dying
	//21 - enemy1_dying
	/*void		*env_pack[ENV_COUNT];
	size_t		env_pack_size[ENV_COUNT];
	SDL_RWops	*env_rw[ENV_COUNT];*/
	Mix_Chunk	*env[ENV_COUNT];
}                t_sound;
